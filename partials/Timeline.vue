    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="pb-12 md:pb-20">
        ...
        <div class="max-w-3xl mx-auto -my-4 md:-my-6" data-aos-id-timeline>
          <!-- 1st item -->
          <div
            class="relative py-4 md:py-6 pl-24"
            data-aos="fade-up"
            data-aos-anchor="[data-aos-id-timeline]"
          >
            <div class="pl-2">
              <div
                class="font-architects-daughter text-xl text-purple-500 mb-2"
              >
                The seed
              </div>
              <div class="flex items-center mb-3">
                ...
                <div
                  ...
                  aria-hidden="true"
                ></div>
                <h4 class="h4">I was born in Arlington Hospital.</h4>
              </div>
          ...
          >
            <div class="pl-2">
              ...
              <div class="flex items-center mb-3">
                ...
                ></div>
                <h4 class="h4">
                  I graduate from Centreville High School with a huge passion
                  for guitar.
                </h4>
              </div>
              <!-- <p class="text-lg text-gray-400">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</p> -->
          ...
          >
            <div class="pl-2">
              ...
              <div class="flex items-center mb-3">
                ...
                ></div>
                <h4 class="h4">
                  I study abroad in Madrid, Spain and switch course from
                  Economics to becoming an Filmmaker.
                </h4>
              </div>
              <!-- <p class="text-lg text-gray-400">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</p> -->
            </div>
          ...
          >
            <div class="pl-2">
              ...
              <div class="flex items-center mb-3">
                ...
                ></div>
                <h4 class="h4">
                  I graduate from New York University, Tisch School of the Arts
                  with a B.F.A.
                </h4>
              </div>
              <!-- <p class="text-lg text-gray-400">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</p> -->
          ...
          >
            <div class="pl-2">
              ...
              <div class="flex items-center mb-3">
                ...
                ></div>
                <h4 class="h4">
                  I start my Development career in earnest, and catch the bug
                  for hackathons.
                </h4>
              </div>
              <!-- <p class="text-lg text-gray-400">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</p> -->
          ...
          >
            <div class="pl-2">
              ...
              <div class="flex items-center mb-3">
                ...
                ></div>
                <h4 class="h4">
                  I will be blessed with a wife, newborn, home, and be working
                  full time on my own side hustle.
                </h4>
              </div>
              <!-- <p class="text-lg text-gray-400">Pretium lectus quam id leo. Urna et pharetra pharetra massa massa. Adipiscing enim eu neque aliquam vestibulum morbi blandit cursus risus.</p> -->
            </div>
