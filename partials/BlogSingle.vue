      ...
      <div class="pb-12 md:pt-20 md:pb-20">
          ...
          <article>
                ...
                >
                  <a href="#0">
                    <img
                      ...
                      :src="require('~/assets/tc-crop-purple.png')"
                      width="40"
                      height="40"
                      alt="Author 04"
                    />
            ...
            <div class="text-lg text-gray-400">
              <p class="mb-8">
                ...
                sed. Elit sed vulputate mi sit amet mauris commodo quis
                imperdiet.
              </p>
              <blockquote class="italic pl-4 border-l-2 border-gray-200 mb-8">
                Greg Korshak, a journalist for the New York Times, reported that
                e-commerce audience will reach 380 million worldwide this year,
                comprising 250 dedicated fans and 215 occasional viewers. New
                York Times projected that the e-commerce industry would generate
                $905 million in revenue in 2020.
              </blockquote>
              <p class="mb-8">
              ...
              <figure class="mb-8">
                <img
                  ...
                  alt="News inner"
                />
                <figcaption class="text-sm text-center text-gray-500 mt-3">
              ...
              <p class="mb-8">
                ...
                risus ultricies tristique nulla aliquet. Morbi tristique
                senectus et netus et, nibh nisl condimentum id venenatis a
                condimentum vitae sapien.
              </p>
              <h4 class="font-medium text-gray-200 mb-8">
              ...
              <p class="mb-8">
                Non nisi est sit amet facilisis magna etiam, aliquet porttitor
                lacus luctus accumsan tortor posuere. Habitasse platea dictumst
                quisque sagittis purus sit amet volutpat consequat. Id velit ut
              ...
              <h4 class="h4 text-gray-200 mb-4">
                1. The quick brown fox jumped over the lazy dog.
              </h4>
              <p class="mb-8">
                Sed risus ultricies tristique nulla aliquet morbi tristique
                senectus et netus et. Nibh nisl condimentum, id venenatis a
                condimentum vitae sapien.
              </p>
              <h4 class="h4 text-gray-200 mb-4">
              ...
              <p class="mb-8">
                Sapien nec sagittis aliquam malesuada orci sagittis eu volutpat
                odio facilisis mauris sit amet massa, consectetur adipiscing
                elit duis tristique sollicitudin nibh sit amet commodo, purus
                viverra accumsan in nisl nisi scelerisque. Vel pharetra vel
                turpis nunc eget lorem malesuada bibendum arcu vitae elementum
                curabitur vitae nunc sed velit. Tempus quam pellentesque nec nam
        ...
        <aside class="mt-20">
          <div class="max-w-sm mx-auto md:max-w-none">
            <!-- Section title -->
            <h4 class="h4 py-6 mb-10 border-t border-b border-gray-700">
              Recommended posts
            </h4>

            <!-- Articles container -->
            <div
              class="grid gap-12 md:grid-cols-3 md:col-gap-6 md:row-gap-8 items-start"
            >
              <!-- 1st article -->
