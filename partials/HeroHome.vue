      ...
      <div class="relative pb-10 md:pt-20 md:pb-16">
        ...
        <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
          ...
          >
            <div class="relative">
              <img
                class="m-auto md:max-w-none rounded-full object-contain"
          ...
          >
            <div class="md:pr-4 lg:pr-12 xl:pr-16">
              ...
              <h1 class="h1 mb-4 text-center md:text-left" data-aos="fade-up">
                Andrew <br />Inhwan Kim
              </h1>

              <p
                class="text-xl mb-8 text-gray-400 text-center md:text-left"
                data-aos="fade-up"
                data-aos-delay="200"
              >
              ...
              <div class="max-w-xs mx-auto sm:max-w-none sm:flex">
                <div
                  class="m-auto md:m-0 md:w-auto w-full"
                  data-aos="fade-up"
                  data-aos-delay="400"
                >
                  <router-link
