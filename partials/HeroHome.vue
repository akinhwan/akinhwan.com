<template>
  <section>
    <div class="max-w-6xl mx-auto px-4 sm:px-6 relative">
      ...
      <div class="absolute left-0 bottom-0 -ml-20 hidden lg:block pointer-events-none" aria-hidden="true"
        data-aos="fade-up" data-aos-delay="400">
        <svg class="max-w-full" width="564" height="552" viewBox="0 0 564 552" fill="none"
      ...
      <div class="relative pb-10 md:pt-20 md:pb-16">
        ...
        <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
          <!-- Image -->
          <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-5 mb-8 md:mb-0 md:order-1"
            data-aos="fade-up" data-aos-anchor="[data-aos-id-features-home]">
            <div class="relative">
              <img class="m-auto md:max-w-none rounded-full object-contain" :src="require('~/assets/tc-crop-purple.png')" width="300" height="300"
          ...
          <!-- Content -->
          <div class="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-7" data-aos="fade-right"
            data-aos-anchor="[data-aos-id-features-home]">
            <div class="md:pr-4 lg:pr-12 xl:pr-16">
                            <div class="font-architects-daughter text-center md:text-left text-xl text-purple-500 mb-2">Hi there, my name is</div>

              <h1 class="h1 mb-4 text-center md:text-left" data-aos="fade-up">Andrew <br>Inhwan Kim</h1>

              <p class="text-xl mb-8 text-gray-400 text-center md:text-left" data-aos="fade-up" data-aos-delay="200">I'm a Developer & Designer
                <!-- <br> Building in public my side-hustles. -->
                <br> based in Northern Virginia, USA
                </p>
              ...
              <div class="max-w-xs mx-auto sm:max-w-none sm:flex">
                <div class="m-auto md:m-0 md:w-auto w-full" data-aos="fade-up" data-aos-delay="400">
                  <router-link class="btn text-white bg-purple-600 hover:bg-purple-700 w-full mb-4 sm:mb-0 text-center md:text-left"
                    to="/newsletter">
                    My Latest Project
              ...
              <!-- <a class="btn text-white bg-gray-700 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="https://calendly.com/akinhwan/15min">
              Let's chat</a> -->
            </div>            
              </div>
            </div>
        ...
        <div>
          <!-- <div class="relative flex justify-center items-center" data-aos="fade-up" data-aos-delay="200">
            <img class="mx-auto" :src="require('~/assets/hero-image-01.jpg')" width="1024" height="504" alt="Hero" />
