    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20 border-t border-gray-800">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12" data-aos-id-tabs>
          <h2 class="h2 mb-4" data-aos="fade-up" data-aos-anchor="[data-aos-id-tabs]">Here's some of my work.</h2>
          <p class="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-tabs]">These are just quick overviews, click to learn more on each card.</p>
        </div>
        ...
        <div>
          ...
          <!-- Tabs buttons -->
          <div class="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
            <button :class="{ 'opacity-50': tab !== '1' }" class="flex items-center font-medium py-2 px-4 m-2 bg-gray-800 rounded-full group transition duration-500" @click="tab = '1'">
              ...
              <span class="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Pubmed.gov</span>
            </button>
            <button :class="{ 'opacity-50': tab !== '2' }" class="flex items-center font-medium py-2 px-4 m-2 bg-gray-800 rounded-full group transition duration-500" @click="tab = '2'">
              ...
              <span class="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Pitchgen.co</span>
            </button>
            <button :class="{ 'opacity-50': tab !== '3' }" class="flex items-center font-medium py-2 px-4 m-2 bg-gray-800 rounded-full group transition duration-500" @click="tab = '3'">
              ...
              <span class="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Soheco.org</span>
            </button>
          ...
          <div class="relative flex flex-col mt-16" data-aos="fade-up">
              ...
              <div class="w-full" v-show="tab === '1'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  <figure class="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                    <img class="w-full h-full object-cover" :src="require('~/assets/pubmed-home.png')" width="516" height="387" alt="Tabs 01" />
                  </figure>
                  <div class="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                    <h4 class="h4 mb-2">Pubmed.gov</h4>
                    <p class="text-lg text-gray-400">The flagship public site by the National Center for Biotechnology Information (NIH/NLM/NCBI).   Serving over 4 million DAU with 30 million + citations for biomedical literature.</p>
                    <a class="btn-sm text-white bg-purple-600 hover:bg-purple-700 mt-6" rel="nofollow noreferrer noopener" target="_blank" href="https://www.pubmed.gov">
              ...
              <div class="w-full" v-show="tab === '2'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  <figure class="md:absolute md:inset-y-0 md:left-0 md:w-1/2">
                    <img class="w-full h-full object-cover" :src="require('~/assets/pitchgen-home.png')" width="516" height="387" alt="Tabs 02" />
                  </figure>
            ...
            >
              <div class="w-full" v-show="tab === '3'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  <figure class="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                    <img class="w-full h-full object-cover" :src="require('~/assets/soheco.png')" width="516" height="387" alt="Tabs 01" />
                  </figure>
                  <div class="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
            ...
            >
              <div class="w-full" v-show="tab === '5'">
                <article class="relative max-w-md mx-auto md:max-w-none">
                  <figure class="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                    <img class="w-full h-full object-cover" :src="require('~/assets/tabs-image-01.jpg')" width="516" height="387" alt="Tabs 01" />
                  </figure>
                  <div class="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
