      ...
      <div class="pt-12 md:pt-20 border-t border-b border-gray-800">
        ...
        >
          ...
          <p
            ...
            data-aos-anchor="[data-aos-id-cta]"
          >
            I am always open & available to hearing how I can help you solve
            your problem.
          </p>
          ...
          >
            <a
              class="btn text-white bg-purple-600 hover:bg-purple-700"
              href="#0"
              >Schedule a time</a
            >
          </div>
          ...
          >
            ...
            >
              <svg
                class="w-3 h-3 fill-current text-green-500 mr-2 flex-shrink-0"
                viewBox="0 0 12 12"
            ...
            >
              ...
              <span>Referral to my network</span>
            </li>
          </ul>
        </div>
      </div>
