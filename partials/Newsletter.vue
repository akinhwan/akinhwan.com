<template>
  <section>
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <!-- CTA box -->
      <div
        class="relative bg-purple-700 py-10 px-8 md:py-16 md:px-12"
        data-aos="fade-up"
      >
        ...
        >
          ...
          <div class="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
            ...
            View the archive here, currently on the #1st edition -->
            <!-- <p class="text-purple-200 text-lg">Instant un-subscribe, no spam ever.</p> -->
          </div>
