      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div class="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
          ...
          <div class="md:col-span-4 lg:col-span-5">
            <div class="mb-2">
              <br />
              <!-- Logo -->
              <!-- <router-link to="/" class="inline-block" aria-label="logo">
            ...
            <div class="text-gray-400">
              🙏 Thank you for visiting my site, especially when there is so
              much to do in so little time. Be sure to stay in touch as I'm easy
              to reach online.
            </div>
          </div>
          ...
          <div class="md:col-span-8 lg:col-span-7 grid sm:grid-cols-3 gap-8">
            ...
            <!-- 3rd block -->
            <div class="text-sm">
              <h6 class="text-gray-200 font-medium mb-1 invisible">
                Recommendations
              </h6>
              <ul>
                <li class="mb-1">
                ...
                <!-- <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">📺 Watch</router-link>
                </li> -->
                <!-- <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">💬 Quotes</router-link>
                </li> -->
                <!-- <li class="mb-1">
            ...
            <!-- 4th block -->
            <div class="text-sm">
              <h6 class="text-gray-200 font-medium mb-1 invisible">Sitemap</h6>
              <ul>
                <li class="mb-1">
                  <router-link
                    to="/newsletter"
                ...
                <!-- <li class="mb-1">
                  <router-link to="#" class="text-gray-400 hover:text-gray-100 transition duration-150 ease-in-out">FAQ</router-link>
                </li> -->
                <!-- <li class="mb-1">
        ...
        <div class="md:flex md:items-center md:justify-between">
          ...
          <ul class="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <a
                ...
                target="_blank"
                href="https://twitter.com/intent/user?screen_name=akinhwan"
                class="
                  flex
                  justify-center
                  items-center
                  text-purple-600
                  bg-gray-800
                  hover:text-gray-100 hover:bg-purple-600
                  rounded-full
                  transition
                  duration-150
                  ease-in-out
            ...
            <!-- <li class="ml-4">
              <a rel="nofollow noreferrer noopener" target="_blank" href="#" class="flex justify-center items-center text-purple-600 bg-gray-800 hover:text-gray-100 hover:bg-purple-600 rounded-full transition duration-150 ease-in-out" aria-label="Facebook">
            ...
            <li class="ml-4">
              <a
                rel="nofollow noreferrer noopener"
                target="_blank"
                href="https://www.instagram.com/devosuals/"
                class="
                  flex
                  justify-center
                  items-center
          ...
          <div class="text-gray-400 text-sm mr-4">
            &copy; 2022 Akinhwan. All rights reserved.
          </div>
        </div>
      </div>
    </div>
