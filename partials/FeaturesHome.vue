          ...
          <div class="md:grid md:grid-cols-12 md:gap-6 items-center">
            ...
            >
              <div class="relative">
                <img
                  class="md:max-w-none"
                  :src="require('~/assets/features-illustration.png')"
                  width="540"
                  height="520"
            ...
            >
              <div class="md:pr-4 lg:pr-12 xl:pr-16">
                ...
                <h3 class="h3 mb-3">Say hello to research data</h3>
                <p class="text-xl text-gray-400 mb-4">
                  Duis aute irure dolor in reprehenderit in voluptate velit esse
                  cillum dolore pariatur. Excepteur sint occaecat cupidatat non
                  proident, sunt in culpa.
                </p>
                <!-- <ul class="flex flex-wrap text-lg text-gray-400 -mx-2 -my-1">
                ...
                <div class="flex items-start mt-8">
                  <img
                    ...
                    :src="require('~/assets/features-avatar.jpg')"
                    width="40"
                    height="40"
                    alt="Features avatar"
                  />
                  <div>
                    <blockquote class="text-gray-400 italic mb-3">
                      "Lorem ipsum is placeholder text commonly used in the
                      graphic, print, and publishing".
                    </blockquote>
                    <div class="text-gray-700 font-medium">
                      <cite class="text-gray-200 not-italic"
                        >— Anastasia Dan</cite
                      >
                      -
                      <a
